...
var _user$project$Board$getRows = function (board) {
	...
	var boardSize = _elm_lang$core$Array$length(board);
	return A2(
		_elm_lang$core$List_ops['::'],
		A3(_elm_lang$core$Array$slice, 0, rowSize, board),
		A2(
			_elm_lang$core$List_ops['::'],
			A3(_elm_lang$core$Array$slice, rowSize, rowSize + rowSize, board),
			A2(
				_elm_lang$core$List_ops['::'],
...
var _user$project$Board$getMarker = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$Native_Utils.eq(
		A2(
			_elm_lang$core$Basics_ops['%'],
			_user$project$Board$countOccupiedSpaces(_p1.board),
			2),
		0) ? 'X' : 'O';
};
var _user$project$Board$makeMove = F3(
	function (_p2, move, marker) {
		var _p3 = _p2;
		return A3(_elm_lang$core$Array$set, move, marker, _p3.board);
	});

var _user$project$Types$GameState = F6(
	function (a, b, c, d, e, f) {
		return {board: a, status: b, player1Type: c, player1Marker: d, player2Type: e, player2Marker: f};
	});
			...
			A2(
				...
				A2(
					...
					_elm_lang$core$Array$map(
						function (x) {
							return _elm_lang$core$Native_Utils.eq(x, marker);
						}),
					possibleWins)));
	});
var _user$project$Game$hasWinner = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1.board;
	return A2(_user$project$Game$checkMarkerForWin, _p2, _p1.player1Marker) || A2(_user$project$Game$checkMarkerForWin, _p2, _p1.player2Marker);
};
...
var _user$project$UI$getMenuHTML = function (_p0) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$html$Html_Attributes$attribute, 'margin-left', 'auto'),
				A2(_elm_lang$html$Html_Attributes$attribute, 'margin-right', 'auto'),
				A2(_elm_lang$html$Html_Attributes$attribute, 'align', 'center')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Welcome To TicTacToe!!')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Please select a game type...')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Human vs Human')
					])),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Human vs Computer')
					])),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Computer vs Human')
					]))
			]));
};
var _user$project$UI$getTurnText = F2(
...
var _user$project$UI$getBoardHTML = function (_p4) {
	...
	var _p7 = _p5.status;
	var _p6 = _p5.board;
	var displayBoard = A2(_user$project$UI$getDisplayBoard, _p6, _p7);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(
				A2(_user$project$UI$getTurnText, _p6, _p7)),
				A2(
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						board: A3(
							...
							model,
							_p0._0,
							_user$project$Board$getMarker(model))
					});
			default:
				var _p1 = _p0._0;
				switch (_p1.ctor) {
					case 'HvH':
						return _elm_lang$core$Native_Utils.update(
							model,
							{status: _user$project$Types$InProgress, player1Type: 'Human', player2Type: 'Human'});
					case 'HvC':
						return _elm_lang$core$Native_Utils.update(
							model,
							{status: _user$project$Types$InProgress, player1Type: 'Human', player2Type: 'Computer'});
					default:
						return _elm_lang$core$Native_Utils.update(
							model,
							{status: _user$project$Types$InProgress, player1Type: 'Computer', player2Type: 'Human'});
				}
		}
	});
