	...
	function (list, index, maxIndex, maxVal) {
		...
		while (true) {
			...
			if (_p0.ctor === '[]') {
				...
				var _p2 = _p0._1;
				var _p1 = _p0._0;
				if (_elm_lang$core$Native_Utils.cmp(_p1, maxVal) > 0) {
					var _v1 = _p2,
						_v2 = index + 1,
						_v3 = index,
						_v4 = _p1;
...
var _tcmcgee$elm_ttt$Main$update = F2(
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p0.ctor) {
				case 'PlayAgain':
					return {ctor: '_Tuple2', _0: _tcmcgee$elm_ttt$Game$getNewGameState, _1: _elm_lang$core$Platform_Cmd$none};
				case 'TakeTurn':
					var _p1 = _p0._0;
...
var _tcmcgee$elm_ttt$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _tcmcgee$elm_ttt$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _tcmcgee$elm_ttt$Game$getNewGameState, _1: _elm_lang$core$Platform_Cmd$none},
			view: _tcmcgee$elm_ttt$Main$view,
			update: _tcmcgee$elm_ttt$Main$update,
			subscriptions: _tcmcgee$elm_ttt$Main$subscriptions
		})
};
